...
my $DetectorName = 'meic_det1_solenoid_dual';
...
make_meic_det1_solenoid_dual_coil_side_eleside();
make_meic_det1_solenoid_dual_coil_side_ionside();
make_meic_det1_solenoid_dual_coil_eleside();
make_meic_det1_solenoid_dual_coil_ionside();
make_meic_det1_solenoid_dual_cryo_eleside();
make_meic_det1_solenoid_dual_cryo_ionside();
}
...
sub make_meic_det1_solenoid_dual_coil_side_eleside
{
 my $NUM  = 1;
...
sub make_meic_det1_solenoid_dual_coil_side_ionside
{
 my $NUM  = 1;
 my @z    = (160.5+20+$offset_inner);
 my @Rin  = (150);
...
sub make_meic_det1_solenoid_dual_coil_eleside
{
 my $coilthickness=17;
 my $NUM  = 7;
...
sub make_meic_det1_solenoid_dual_coil_ionside
{
 my $coilthickness=17;
 my $NUM  = 7;
 my @z    = (412.5+3.5+$offset,412.5+3.5+$offset,412.5+3.5+$offset,412.5+3.5+$offset,412.5+3.5+$offset,412.5+3.5+$offset,412.5+3.5+$offset);
...
sub make_meic_det1_solenoid_dual_cryo_eleside
{
 my $NUM  = 1;
...
sub make_meic_det1_solenoid_dual_cryo_ionside
{
 my $NUM  = 1;
