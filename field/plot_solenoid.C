...
int Num_R=300,Num_Z=1600;
const int constNum_R=Num_R+1,constNum_Z=Num_Z+1;

TH1F *hBz_axis = new TH1F("Bz_axis","Bz;Z(cm)",Num_Z,Zmin-0.5,Zmax-0.5);

TH2F *hBr = new TH2F("Br","Br;Z(cm);R(cm)",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hBz = new TH2F("Bz","Bz;Z(cm);R(cm)",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hB = new TH2F("B","B;Z(cm);R(cm)",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hdBzdr = new TH2F("dBzdr","dBz/dz;Z(cm);R(cm);;Z(cm);R(cm)",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hdBrdz = new TH2F("dBrdz;Z(cm);R(cm);","dBr/dz;Z(cm);R(cm)",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hFI = new TH2F("Field Index","Field Index;Z(cm);R(cm)",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
TH2F *hBperp = new TH2F("Bperp","abs(B) perpendicular to path;Z(cm);R(cm)",Num_Z,Zmin-0.5,Zmax-0.5,Num_R,Rmin-0.5,Rmax-0.5);
